...
class PSOFunction {
	...
	private static final double INFINITY = 999999; // Double.POSITIVE_INFINITY;
	private int nodes;
...
//	System.out.println(pid+ " Time calc in func: \n" + time.toStringOutput());
		...
		for (RTable r : rtable) {
			...
			if (check1 != 0) {
				System.out.println("RSU Fail: " + j3 + " " + r.getDes() + " " + check1);
...
//	System.out.println(pid+ " Time calc in func: \n" + time.toStringOutput());
		...
		for (RTable r : rtable) {
			...
			// System.out.println("rtable: " + j3 + " " + r.getTimeCompute());
			if (check1 != 0) {
				System.out.println("Vehicle Fail: " + j3 + " " + r.getDes() + " " + check1);
			//	System.out.println(worker.toStringOutput()); 
